...
// const keepaToFlatSalesGraphData = (graphData, opts = {}) => {
//   const {
//     priceDivisor = 100,
//     locale = 'en-US',
...
// const keepaToFlatOfferGraphData = (graphData, opts = {}) => {
//   const {
//     priceDivisor = 100,
//     locale = 'en-US',
//     dateFormatOptions = { month: 'short', day: 'numeric' },
...
//   const offerCountMap = parsePairsToMap(graphData.offerCountHistory || [], rankTransform);

//   // union of all timestamps
//   const tsSet = new Set([...offerCountMap.keys()]);
//   const tsArray = Array.from(tsSet).sort((a, b) => a - b);
...
//     return {
//       date,
//       offerCount: newMap.has(keepaMinute) ? newMap.get(keepaMinute) : null,
//     };
//   });

//   // Forward-fill nulls (per-series) if requested.
//   if (forwardFill && result.length) {
//     const keys = ['offerCount'];
